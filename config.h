...
/* Define to 1 if you have the <gsl_matrix.h> header file. */
/* #undef HAVE_GSL_MATRIX_H */
...
#define PACKAGE_NAME "qti"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "qti 0.01"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qti"
